...
SELECT DISTINCT ON (e.emp_no) e.emp_no, e.first_name, e.last_name, e.birth_date, e.hire_date,  t.from_date, t.to_date, t.title
INTO retiring_mentorship_eligibilty
FROM employees as e
INNER JOIN titles as t
	ON  e.emp_no = t.emp_no
INNER JOIN dept_emp as d
	ON e.emp_no = d.emp_no
WHERE (e.hire_date BETWEEN '1985-01-01' AND '1995-12-31') AND (e.birth_date NOT BETWEEN '1952-01-01' AND '1958-12-31') and t.to_date = '9999-01-01'
ORDER BY e.emp_no;
